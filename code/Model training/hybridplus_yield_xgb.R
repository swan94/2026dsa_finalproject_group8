# Corn Yield Prediction — Monthly (Growing Season) Parent + Hybrid Model  — XGBoost Only
...
out_dir <- "output/monthly_gs_hybridplus_xgb"
...
saveRDS(xgb_full_fit, file.path(out_dir, "xgb_monthly_gs_hybridplus_fit.rds"))

log_msg("SUCCESS: completed XGBoost hybrid-plus run")
sessionInfo()